...
ברוכים הבאים למערכת **SCAR (Supply Chain Anomaly Radar)** - מערכת מקיפה מבוססת דאטה המיועדת לזיהוי, ניתוח והתראה על שיבושים ותמורות בשרשראות אספקה גלובליות של סחורות חיוניות לישראל.
